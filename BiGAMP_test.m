...
while ~stop
    ...
    if ~uniformVariance
        ...
        mxhat2 = abs(norm(xhat,'fro')).^2/numel(xhat);
        mAhat2 = abs(norm(Ahat,'fro')).^2/numel(Ahat);
    ...
    if ~sparseMode
        if uniformVariance
            switch gainMode
                ...
                case 2,
                    rGain = 1 - ...
                        Avar*abs(norm(shat,'fro'))^2/numel(shat)...
                        /mAhatBar2/svar;
                case 3,
                    rGain = 1;
            end
        ...
        if uniformVariance
            switch gainMode
                ...
                case 2,
                    rGain = 1 - ...
                        Avar*abs(norm(shatMat,'fro'))^2/numel(shatMat)...
                        /mAhatBar2/svar;
                case 3,
                    rGain = 1;
            end
            ...
            switch gainMode
                ...
                case 2,
                    rGain = (1 - (rvar.*(Avar'*abs(shatMat).^2)));
                case 3,
                    rGain = 1;
            end
        end
    ...
    if uniformVariance
        mxhatBar2 = abs(norm(xhatBar,'fro'))^2/numel(xhatBar);
    ...
    if ~sparseMode
        if uniformVariance
            switch gainMode
                ...
                case 2
                    qGain = 1 - ...
                        xvar*abs(norm(shat,'fro'))^2/numel(shat)...
                        /mxhatBar2/svar;
                case 3
                    qGain = 1;
            end
        ...
        if uniformVariance
            switch gainMode
                ...
                case 2
                    qGain = 1 - ...
                        xvar*abs(norm(shatMat,'fro'))^2/numel(shatMat)...
                        /mxhatBar2/svar;
                case 3
                    qGain = 1;
            end
            ...
            switch gainMode
                ...
                case 2
                    qGain = (1 - (qvar.*(abs(shatMat).^2*xvar')));
                case 3
                    qGain = 1;
            end
        end
    ...
    if compVal
       % [xhat,xvar,valInX] = gX.estim(rhat, rvar*pvar_mean);
        ...
        xvar = zeros(size(X)) ;
        valInX = 0;
        [Ahat,Avar,valInA] = gA.estim(qhat, qvar*pvar_mean, Sam, D, P_num);
